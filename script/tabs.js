...
Tabs.activeTabStyle = 'white-space: nowrap; margin: 0; border: 1px solid #555555; border-bottom-width: 0; font: 14px "Calibri", Arial, serif;';
Tabs.inactiveTabStyle = 'white-space: nowrap; margin: 0; border: 1px solid #888888; background: #CCCCCC; font: 14px "Calibri", Arial, serif;';
Tabs.paddingStyle = 'margin: 0; border: 0 solid #888888; border-bottom-width: 1px;';
Tabs.panesStyle = 'margin: 0; border: 1px solid #888888; border-top-width: 0; padding: 5px;';
Tabs.paddingStr = '&nbsp;';
...
Tabs.prototype.Add = function ( name, activateCallback )
    ...
    tabElement.innerHTML = '<a href="javascript:Tabs.Switch(' + globalItemId + ')">' + name + '</a>';
