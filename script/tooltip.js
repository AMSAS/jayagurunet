...
function tt_Hide()
{
	if(tt_db && tt_iState)
	{
		...
		// In case of a TagToTip tip, hide converted DOM node and re-insert it into DOM
...
// Create command names by translating config variable names to upper case
...
function tt_FormatTip()
{
	...
	css.lineHeight = tt_aV[LINEHEIGHT];
